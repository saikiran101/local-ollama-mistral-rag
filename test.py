...
pdf_path = r"C:\Users\sai51\Documents\Python Programming\Learning_Python.pdf"
...
# # Load and process the PDF (this part remains largely unchanged)
# print(f"Loading content from: {pdf_path}")
# loader = PyPDFLoader(pdf_path)
# data = loader.load()
# text_splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200)
...
#     embedding=embeddings,
#     collection_name="pdf-content-rag",
#     persist_directory="local_ollama_mistral_Rag/store/vector_database"
# )
# vector_store.persist()
...
#         return AnswerOutput(answer=answer, confidence=confidence)
#     except Exception as e:
#         raise HTTPException(status_code=500, detail=str(e))
